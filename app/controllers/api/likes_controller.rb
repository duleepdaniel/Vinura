...
module API
  class LikesController < ApplicationController
    ...
    def create
      ...
      notify_author
      render json: { liked: true, count: @likeable.reload.likes.size, type: @likeable.class.to_s, id: @likeable.id },
             status: 200
    end
    ...
    def destroy
      ...
      render json: { liked: false, count: @likeable.reload.likes.size, type: @likeable.class.to_s, id: @likeable.id },
             status: 200
    end
