  ...
  describe 'Access Control' do
    describe 'PATCH #update' do
      ...
      it 'requires a logged-in user' do
        patch :update, params: { id: post.id, post: { title: 'Updated title', body: 'Updated body' } }, xhr: true
      ...
      it "doesn't let user update other users post and raise an error" do
        ...
        expect { patch :update, params: { id: others_post.id, post: { title: 'hello', body: 'world' } }, xhr: true }
  ...
  context 'when user is logged-in' do
    ...
    describe 'updating drafts' do
      before :each do
        ...
        patch :update, params: { id: draft.id, post: { title: 'updated title', body: 'updated body' } }, xhr: true
    ...
    describe 'updating published posts' do
      before :each do
        ...
        patch :update, params: { id: published_post.id, post: { title: 'updated title', body: 'updated body' } },
                       xhr: true
