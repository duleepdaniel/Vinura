...
RSpec.describe PostsController do
  describe 'Access Control' do
    ...
    describe 'POST #create' do
      subject { post :create, params: { title: 'Awesome title', body: 'Awesome Content' } }
    ...
    context 'when a user trying to edit, update, or delete other users post' do
      ...
      it 'does not allow user to update post' do
        patch :update, params: { id: other_user_post.id, post: attributes_for(:post) }
        expect(response).to redirect_to(root_path)
      end
    ...
    context 'when user is signed in' do
      ...
      describe 'POST #create_and_edit' do
        it 'creates a post and redirect_to edit page' do
          ...
          expect do
            post :create_and_edit, params: { post: { title: @draft.title, body: @draft.body } }
  ...
  describe 'Unhappy Path' do
    ...
    describe 'PATCH #update' do
      ...
      it 'fails gracefully when it fails validations' do
        patch :update, params: { id: @draft.id, post: attributes_for(:draft, body: '   ') }
